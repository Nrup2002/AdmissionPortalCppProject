...
void Student::getData()
{
  ...
  cout << "\t\t\tEnter Full Address      : "; getline(cin, address);
  cout << "\t\t\tEnter Country           : "; getline(cin, Nationality);
  cout << "\t\t\tEnter state on Domicile : "; getline(cin, Dstate);
  cout << "\t\t\tBranch available        :\n\t\t\t  >1. Computer Science and Engg.\n";
  cout << "\t\t\t  >2. Information Technology\n\t\t\t  >3. Artificial Intelligence\n";
  cout << "\t\t\tEnter Choice            : "; cin >> branch;
  cout << "\t\t\tEnter your Phone no     : "; cin >> phone_no;
  cout << "\t\t\tEnter your Email_ID     : "; cin >> email;

  cout << "\n\n\t\t\t\tStep 1 Completed.....  ";	getch();
  system("cls");	heading();
...
void Student::finalData(){
  ...
  ifstream fin("Students.dat");
  float cut_score;
  cout<<"\n\t\t\t\tEnter cut off score : "; cin>>cut_score;
  cout << "\n-------------------------------------------------------";
  cout << "------------------------------------------------------\n";
